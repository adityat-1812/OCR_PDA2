# Generated by Django 3.0.5 on 2023-05-19 22:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('input_img', models.ImageField(blank=True, null=True, upload_to='prescriptions/')),
                ('prescription_scanned_date', models.DateField(null=True)),
                ('texted_prescriptions', models.TextField(blank=True, max_length=500, null=True)),
                ('patientIDKey', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='hospital.Patient')),
            ],
        ),
        migrations.CreateModel(
            name='Doctor',
